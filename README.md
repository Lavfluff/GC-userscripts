...
- [**Quickstock Overhaul**](https://github.com/Lavfluff/GC-userscripts/blob/main/gc-quickstock-overhaul.js): Groups items in the [Quickstock](https://www.grundos.cafe/quickstock/) menu by name and adds buttons to perform group actions on them.
